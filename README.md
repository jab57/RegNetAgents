...
@software{bird_2026_regnetagents,
  ...
  year      = {2026},
  version   = {1.2.7},
  doi       = {10.5281/zenodo.22238647},
  url       = {https://github.com/jab57/RegNetAgents},
  license   = {MIT}
}
```

Bird, J.A. (2026). *RegNetAgents: Multi-Agent LLM Framework for Gene Regulatory Network Analysis* (v1.2.7). https://doi.org/10.5281/zenodo.22238647
