...
- Uses pre-computed regulatory networks from the GREmLN team (generated by the ARACNe algorithm)
...
The system currently supports 10 cell types with pre-generated regulatory networks from the GREmLN team (downloaded from the [GREmLN Quickstart Tutorial](https://virtualcellmodels.cziscience.com/quickstart/gremln-quickstart)).
