#!/usr/bin/env python3
"""
Test script for the GREmLN LangGraph-powered MCP Server
...
async def test_langgraph_mcp_tools():
    ...
    print("Testing GREmLN LangGraph-powered MCP Server...")

    try:
        # Import the server components
        from gremln_langgraph_mcp_server import handle_call_tool, get_workflow
...
async def demonstrate_workflow_advantages():
    ...
    config = {
        "mcpServers": {
            "gremln-langgraph-server": {
                "command": "python",
                "args": ["C:/Users/josea/OneDrive/Desktop/GREmLN/gremln_langgraph_mcp_server.py"],
                "env": {
