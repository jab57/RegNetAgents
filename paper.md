...
- **Hybrid architecture**: Combines optional LLM-powered interpretation with a deterministic rule-based layer that produces categorical evidence assessments (high/moderate/low) with supporting factors — no pseudo-scientific float scores
