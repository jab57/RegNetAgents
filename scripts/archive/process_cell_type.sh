...
# RegNetAgents Cell Type Processing Script
...
log "=== Starting RegNetAgents processing for $CELL_TYPE ==="
...
ARACNE_EXEC="$BASE_DIR/regnetagents_source/scripts/ARACNe3_app_release"
